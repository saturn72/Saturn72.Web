intellisense.annotate(jQuery, {
  ...
  'extend': function() {
    ...
    ///   <param name="destinationPath" type="Object">An object that will receive the new properties if additional objects are passed in or that will extend the jQuery namespace if it is the sole argument.</param>
    ...
    ///   <param name="destinationPath" type="Object">The object to extend. It will receive the new properties.</param>
    ///   <param name="object1" type="Object">An object containing additional properties to merge in.</param>
    ///   <param name="objectN" type="Object">Additional objects containing properties to merge in.</param>
    ///   <returns type="Object" />
    /// </signature>
...
intellisense.annotate(_object, {
  ...
  'promise': function() {
    ...
    ///   <param name="destinationPath" type="Object">Object onto which the promise methods have to be attached</param>
    ///   <returns type="Promise" />
    /// </signature>
  },
  'reject': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'appendTo': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of matched elements to the end of the destinationPath.</summary>
    ///   <param name="destinationPath" type="jQuery">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the end of the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'attr': function() {
  ...
  'fadeTo': function() {
    ...
    ///   <param name="opacity" type="Number">A number between 0 and 1 denoting the destinationPath opacity.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'insertAfter': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of matched elements after the destinationPath.</summary>
    ///   <param name="destinationPath" type="jQuery">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted after the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'insertBefore': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of matched elements before the destinationPath.</summary>
    ///   <param name="destinationPath" type="jQuery">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted before the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'is': function() {
  ...
  'prependTo': function() {
    /// <signature>
    ///   <summary>Insert every element in the set of matched elements to the beginning of the destinationPath.</summary>
    ///   <param name="destinationPath" type="jQuery">A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the beginning of the element(s) specified by this parameter.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'prev': function() {
  ...
  'promise': function() {
    ...
    ///   <param name="destinationPath" type="PlainObject">Object onto which the promise methods have to be attached</param>
    ///   <returns type="Promise" />
    /// </signature>
  },
  'prop': function() {
  ...
  'replaceAll': function() {
    /// <signature>
    ///   <summary>Replace each destinationPath element with the set of matched elements.</summary>
    ///   <param name="destinationPath" type="String">A selector expression indicating which element(s) to replace.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'target': function() {
    /// <summary>Selects the destinationPath element indicated by the fragment identifier of the document's URI.</summary>
  },
  'text': function() {
    /// <signature>
