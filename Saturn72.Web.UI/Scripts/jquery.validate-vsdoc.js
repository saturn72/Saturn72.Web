...
$.extend($.validator, {
	...
	methods: {
		...
		equalTo: function(value, element, param) {
			// bind to the blur event of the destinationPath in order to revalidate whenever the destinationPath field is updated
...
// handler is only called when $(event.destinationPath).is(delegate), in the scope of the jquery-object for event.destinationPath 
;(function($) {
