...
namespace Saturn72.Web.Framework.UI
{
    public class PageHeadBuilder : IPageHeadBuilder
    {
        ...
        private const string PageTitleSeparator = "-";
        ...
        public virtual string GenerateTitle(bool addDefaultTitle)
        {
            ...
            if (!string.IsNullOrEmpty(specificTitle))
            {
                if (addDefaultTitle)
                {
                    ...
                    switch (_pageTitleSeoAdjustment)
                    {
                        case PageTitleSeoAdjustment.PageNameAfterPortalName:
                        {
                            result = string.Join(PageTitleSeparator, DefaultTitle, specificTitle);
                        }
                            break;
                        case PageTitleSeoAdjustment.PageNameBeforePortalName:
                        default:
                        {
        ...
        public const string DefaultTitle = "Saturn72 Autoamtion Server";

        private readonly PageTitleSeoAdjustment _pageTitleSeoAdjustment = PageTitleSeoAdjustment.PageNameAfterPortalName;
        ...
        public const string DefaultMetaDescription = "Saturn72 Automation Server";
        ...
        public const string DefaultMetaKeywords = "";
        ...
        public bool EnableJsBundling = true;
        ...
        public const bool EnableCssBundling = true;
